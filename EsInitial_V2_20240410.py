...
import EsRaster,readConfig,RF_Algorithm_V2_RF5_20240420
#SVM_Algorithm,Cubist_Algorithm


if __name__=="__main__":
    '''读取参数文件，并初始化参数'''
    if os.path.exists(EsInitialPath+os.sep+"Parameters20240410.ini"):
        ...
        exlFile = r"G:\1_BeiJingUP\AUGB\Data\20220629\Results\RF_AGB_2024\DataTable\AUGB汇总_AGB汇总ALLdata.xlsx"
    ...
    # allcsv.to_excel(r'G:\1_BeiJingUP\AUGB\Data\20220629\Results\RF_AGB_2024\DataTable\AUGB汇总_AGB汇总ALLdata_allyr1.xlsx', index=False)
    # print()
    #
    # '''## Sample ##'''
    ...
    #     stcDf = EsRaster.SampleRaster_gdal3(staticPath+[r'G:\1_BeiJingUP\CommonData\中国地图-审图号GS(2019)1822号-shp格式\中国地图-审图号GS(2019)1822号-shp格式\全国县级数据_(唐古拉单独处理并更新青藏高原国界)\CHNCounty_ProjAlbers.tif'],
    #                                         yrcsv, 'ID', LonFieldName=r'LON', LatFieldName=r'LAT')
    #     yrcsv = pd.concat([yrcsv,stcDf],axis=1,join='outer')
    #
    #     '''Dynamic raster sample'''
    #     npptif = [glob(r'G:\1_BeiJingUP\AUGB\Data\OtherNPPData' + os.sep + mdname + os.sep + r'Tiff_China\*' + str(yr) + r'*.tif') for mdname in
    ...
    #     dymDf = EsRaster.SampleRaster_gdal3(dymtif+npptif,yrcsv,'ID', LonFieldName=r'LON', LatFieldName=r'LAT',
    ...
    # # allyr.columns = Ycols
    # allyr.to_excel(r'G:\1_BeiJingUP\AUGB\Data\20220629\Results\RF_AGB_2024\DataTable\AUGB汇总_AGB汇总ALLdata_allyr2.xlsx', index=False)

    allyr = pd.read_excel(r'G:\1_BeiJingUP\AUGB\Data\20220629\Results\RF_AGB_2024\DataTable\AUGB汇总_AGB汇总ALLdata_allyr2.xlsx')
    ...
    # deleteIndex = [ 634, 2160, 2189, 2250, 2535]
    # allyr.iloc[deleteIndex,1:5]
    ...
    algX = allyr[Ycols]
    print(Ycols)
    RF_Algorithm_V2_RF5_20240420.RFEstimate(algX, algY, [staticPath, dynamicParasD], 0.92)
