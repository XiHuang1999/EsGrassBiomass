...
fBNPP_Path = r'G:\1_BeiJingUP\AUGB\Data\Analysis_NPP_2\fBNPP'
...
fb1 = fb[['高寒荒漠草原类', '高寒荒漠类', '高寒草甸草原类', '高寒草甸类', '高寒草原类',
          '热性草丛类', '热性灌草丛类',
...
plt.xticks(rotation=0, fontproperties = 'Times New Roman') # 旋转90度,fontsize=10
plt.yticks(rotation=0, fontproperties = 'SimHei',fontsize=8) # 旋转90度,fontsize=10
...
plt.axvline(fbmean, linestyle='dotted', color='k') # 水平线，y需要传入一个具体数值，比如上图是0
